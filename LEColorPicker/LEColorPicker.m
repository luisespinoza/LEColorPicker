...
- (void)pickColorsFromImage:(UIImage *)image
                 onComplete:(void (^)(LEColorScheme *_Nullable colorsPickedDictionary))completeBlock {
    if ([self isAppActive]) {
        [self.operationQueue addOperationWithBlock:^{
            // Color calculation process
            LEColorScheme *_Nullable colorScheme = [self colorSchemeFromImage:image];
...
- (nullable LEColorScheme *)colorSchemeFromImage:(UIImage *)inputImage {
    if ([self isAppActive]) {
        ...
        UIImage *_Nullable scaledImage = [self scaleImage:inputImage
        ...
        UIColor *bgColor = [self colorWithBiggerCountFromImageWidth:LECOLORPICKER_GPU_DEFAULT_SCALED_SIZE
                                                             height:LECOLORPICKER_GPU_DEFAULT_SCALED_SIZE];
        LEColorScheme *colorScheme = [[LEColorScheme alloc] initWithBackgroundColor:bgColor];
...
- (GLuint)setupTextureFromImage:(nullable UIImage *)image {
